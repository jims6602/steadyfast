...
class DictionariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dictionary" do
    assert_difference('Dictionary.count') do
      post dictionaries_url, params: { dictionary: { definition: @dictionary.definition, partOfSpeech: @dictionary.partOfSpeech, word: @dictionary.word, wordUsage: @dictionary.wordUsage } }
    end
  ...
  test "should update dictionary" do
    patch dictionary_url(@dictionary), params: { dictionary: { definition: @dictionary.definition, partOfSpeech: @dictionary.partOfSpeech, word: @dictionary.word, wordUsage: @dictionary.wordUsage } }
